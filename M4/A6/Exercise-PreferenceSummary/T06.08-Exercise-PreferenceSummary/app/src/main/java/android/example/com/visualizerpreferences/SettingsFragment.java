...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!(preference instanceof CheckBoxPreference)) {
                String str1 = sharedPreferences.getString(preference.getKey(), "");
                setPreferenceSummary(preference,str1);
            }
        }
    }
    ...
    private void setPreferenceSummary(Preference preference, String str) {
        if (preference instanceof ListPreference) {
            ...
            int val = listPreference.findIndexOfValue(str);
            if (val >= 0) {
                listPreference.setSummary(listPreference.getEntries()[val]);
            }
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        if (preference != null && !(preference instanceof CheckBoxPreference)) {
            String str2 = sharedPreferences.getString(preference.getKey(), "");
            setPreferenceSummary(preference, str2);
        }
    }
